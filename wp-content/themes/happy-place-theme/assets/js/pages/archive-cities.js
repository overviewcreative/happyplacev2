/**
 * Cities Archive JavaScript
 * 
 * Handles load more functionality for cities archive
 */
...
(function($) {
    ...
    class CitiesArchive {
        ...
        loadMore() {
            ...
            searchParams.action = 'load_more_cities';
            ...
            $.ajax({
                ...
                error: (xhr, status, error) => {
                    alert('Failed to load more cities. Please try again.');
