 ...
 * File: template-parts/listing-card-grid.php
 * 
...
<article class="hph-card hph-card-elevated hph-h-full hph-flex hph-flex-col hph-transition-all hover:hph-shadow-xl">
    <a href="<?php echo get_permalink($listing_id); ?>" class="hph-block hph-h-full hph-flex hph-flex-col">
        
        <!-- Image Container -->
        <div class="hph-relative hph-aspect-ratio-16-9 hph-overflow-hidden hph-bg-gray-200">
        ...
        <div class="hph-p-md hph-flex-grow hph-flex hph-flex-col">
            ...
            <!-- Price -->
            <?php if ($price): ?>
            <div class="hph-text-2xl hph-font-bold hph-text-primary hph-mb-sm">
