 ...
 * File: template-parts/agent-card-grid.php
 *
...
// Card classes
$card_classes = ['agent-card-grid', 'hph-card', 'hph-card-elevated', 'hph-h-full', 'hph-flex', 'hph-transition-all', 'hover:hph-shadow-xl'];
if ($view_type === 'list') {
