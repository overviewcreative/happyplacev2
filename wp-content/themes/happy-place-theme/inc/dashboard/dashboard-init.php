 ...
 * 
 * File Location: /wp-content/themes/happy-place/inc/dashboard/dashboard-init.php
 */
...
class HPH_Dashboard_Init {
    ...
    private function load_dependencies() {
        ...
        // Load page loader
        require_once get_template_directory() . '/inc/dashboard/dashboard-page-loader.php';
        ...
        foreach ($bridge_files as $file) {
            $filepath = get_template_directory() . '/inc/bridge/' . $file;
