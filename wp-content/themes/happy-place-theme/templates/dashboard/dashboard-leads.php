...
<div class="leads-page" id="leadsPage">
    ...
    <div class="page-header">
        <div class="header-stats">
            ...
            <div class="stat-item">
                ...
                <div class="stat-content">
                    <h3 class="stat-value" id="hotLeads">-</h3>
            ...
            <div class="stat-item">
                ...
                <div class="stat-content">
                    <h3 class="stat-value" id="followUpRequired">-</h3>
                    <p class="stat-label">Need Follow-up</p>
                </div>
            </div>
    ...
    <div class="page-controls">
        <div class="controls-left">
            ...
            <div class="filter-group">
                <select class="form-select" id="leadScoreFilter">
        ...
        <div class="controls-right">
            ...
            <button class="btn btn-outline btn-sm" id="exportLeads">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
            ...
            <button class="btn btn-primary btn-sm" id="addLeadBtn">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
    ...
    <div class="leads-content">
        <!-- Loading State -->
        <div class="loading-container" id="leadsLoading">
        ...
        <div class="empty-state" id="emptyState" style="display: none;">
            ...
            <p class="empty-message">When you capture leads, they'll appear here. Start by adding your first lead!</p>
            <button class="btn btn-primary" id="addFirstLead">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                </svg>
                Add Your First Lead
        ...
        <!-- Leads Grid -->
        <div class="leads-grid" id="leadsGrid" style="display: none;">
            <!-- Leads will be loaded here dynamically -->
        </div>
    </div>
    
    <!-- Pagination -->
    <div class="pagination-wrapper" id="leadsPagination" style="display: none;">
...
<div class="modal" id="leadDetailsModal">
    <div class="modal-content modal-lg">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary" id="editLeadBtn">Edit Lead</button>
        </div>
    </div>
</div>

<!-- Add/Edit Lead Modal -->
<div class="modal" id="leadFormModal">
    <div class="modal-content modal-lg">
        <div class="modal-header">
            <h2 class="modal-title" id="leadFormTitle">Add New Lead</h2>
            <button class="modal-close" aria-label="Close">&times;</button>
        </div>
        <div class="modal-body">
            <form id="leadForm" class="lead-form">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="leadFirstName" class="form-label required">First Name</label>
                            <input type="text" id="leadFirstName" name="first_name" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="leadLastName" class="form-label required">Last Name</label>
                            <input type="text" id="leadLastName" name="last_name" class="form-control" required>
                        </div>
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group">
                            <label for="leadEmail" class="form-label required">Email</label>
                            <input type="email" id="leadEmail" name="email" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="leadPhone" class="form-label">Phone</label>
                            <input type="tel" id="leadPhone" name="phone" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="leadStatus" name="status" class="form-select">
                                <option value="new">New</option>
                                <option value="contacted">Contacted</option>
                                <option value="qualified">Qualified</option>
                                <option value="nurturing">Nurturing</option>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="leadScore" class="form-label">Lead Score (0-100)</label>
                            <input type="number" id="leadScore" name="score" class="form-control" min="0" max="100" value="50">
                        </div>
                        <div class="form-group">
                            <label for="leadBudget" class="form-label">Budget Range</label>
                            <select id="leadBudget" name="budget_range" class="form-select">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="leadPropertyType" class="form-label">Property Type</label>
                            <select id="leadPropertyType" name="property_type" class="form-select">
                        ...
                        <div class="form-group">
                            ...
                            <select id="leadBedrooms" name="bedrooms" class="form-select">
                                <option value="">Any</option>
                    ...
                    <div class="form-group">
                        <label for="leadAreas" class="form-label">Preferred Areas</label>
                        <input type="text" id="leadAreas" name="preferred_areas" class="form-control" 
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="leadNotes" name="notes" class="form-control" rows="4" 
